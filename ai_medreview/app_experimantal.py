...
# Dictionary to store the PCNs and their corresponding PINs
pcn_pins = {
    "Demo-PCN": None,
    "Brompton-Health-PCN": "145",
    # Add more PCNs and their PINs here as needed
}

# Define a list of PCNs from the keys of the dictionary
pcn_names = list(pcn_pins.keys())
...
if st.session_state['pin_verified'][selected_pcn]:
    ...
    pcn_data = load_data()[load_data()["pcn"] == selected_pcn]

    # Surgery dropdown should only be displayed based on page selection
    # and after the correct PIN is entered or if no PIN is required
